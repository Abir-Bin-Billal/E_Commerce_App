        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Name : ${userDetailModel.name!.firstname}${userDetailModel.name!.lastname}",
                  style: TextStyle(fontSize: 16),
                ),
                Text("Phone : ${userDetailModel.phone}",
                    style: TextStyle(fontSize: 16)),
                Text("Email : ${userDetailModel.email}",
                    style: TextStyle(fontSize: 16)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Name : ${userDetailModel.address!.city}",
                  style: TextStyle(fontSize: 16),
                ),
                Text("Phone : ${userDetailModel.address!.street}",
                    style: TextStyle(fontSize: 16)),
                Text("Email : ${userDetailModel.address!.zipcode}",
                    style: TextStyle(fontSize: 16)),
                Text(
                  "Name : ${userDetailModel.address!.geolocation}",
                  style: TextStyle(fontSize: 16),
                ),
                Text("Phone : ${userDetailModel.address!.number}",
                    style: TextStyle(fontSize: 16))
              ],
            ),
          ),
